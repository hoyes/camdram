...
class Version20151227024816 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE acts_infobase_articles (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, slug VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, legacy_slug VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_5885DD1F989D9B62 (slug), UNIQUE INDEX UNIQ_5885DD1FB72D207A (legacy_slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE acts_infobase_articles');
